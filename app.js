...
const schedule = "0 */5 * * *"; // The cron syntax '0 */12 * * *' means the job will run at minute 0 past every 12th hour (0, 12), every day of the month, every month, and every day of the week.
